        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              ...
              Easy with our services
            </Typography>

            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              We are a delivery company that provides Rent a Shelf services, Home Delivery and Delivery to our Pickup Mtaani agents for Online Businesses
            </Typography>
