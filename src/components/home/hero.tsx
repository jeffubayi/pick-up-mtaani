      ...
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  Pick-Up Mtaani – taken from Swahili to mean, ‘collect from your neighbourhood’ – helps online businesses deliver their products to customers safely and at an affordable price</Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            <Box sx={{ lineHeight: 0 }}>
              <Image src="/images/homey.png" width={775} height={787} alt="Hero img" />
            </Box>
          </Grid>
        </Grid>
